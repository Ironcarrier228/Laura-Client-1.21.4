...
В свежеустановленном профиле Fabric-лоадер уже перекрывает `org.ow2.asm:9.6`
из профиля Minecraft 1.21.4 на `org.ow2.asm:9.9`, поэтому конфликта нет. На
всякий случай (профиль остался от старого лаунчера или собран вручную) скрипт
дополнительно дедуплицирует classpath и оставляет по одной — самой свежей —
версии каждого артефакта, а в консоль пишет, сколько дублей убрал.
