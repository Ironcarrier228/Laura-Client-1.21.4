...
public class CosmeticsProcessor extends BaseProcessor {
    ...
    private void registerCosmetic(PacketSecurity security, UUID uuid, String cosmetic) {
        ...
        BakedGeoModel bakedModel = BakedModelFactory.getForNamespace("laura").constructGeoModel(GeometryTree.fromModel(KeyFramesAdapter.GEO_GSON.fromJson(geometry, Model.class)));
