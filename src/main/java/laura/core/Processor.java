...
import laura.autobuy.AutoBuyProcessor;
import laura.autobuy.BatchProcessor;
import laura.autobuy.CollectorProcessor;
import laura.command.CommandProcessor;
import laura.config.BaseProcessor;
import laura.config.ModuleProcessor;
import laura.config.ResourcePacksProcessor;
import laura.config.ThemeProcessor;
import laura.cosmetic.CosmeticsProcessor;
import laura.discord.DiscordProcessor;
import laura.friend.FriendProcessor;
import laura.handler.HandlerProcessor;
import laura.handler.RotationProcessor;
import laura.lib.log4j.LoggerFactory;
import laura.macro.MacrosProcessor;
import laura.network.AccountProcessor;
import laura.notification.NotificationProcessor;
import laura.render.Draw2DProcessor;
import laura.render.Draw3DProcessor;
import laura.staff.StaffProcessor;
import laura.ui.element.DragProcessor;
