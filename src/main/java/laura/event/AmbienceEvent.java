...
public class AmbienceEvent {
    ...
    public static class d extends Event {
        private final laura.event.AmbienceEvent.d.type type;
        private float value;
        private Biome.Precipitation precipitation;

        public d(laura.event.AmbienceEvent.d.type type, float value) {
            this.type = type;
            this.value = value;
        }

        public d(laura.event.AmbienceEvent.d.type type, Biome.Precipitation value) {
            this.type = type;
            this.precipitation = value;
        }

        public laura.event.AmbienceEvent.d.type b() {
            return this.type;
        }
