...
import laura.command.CommandExecutor;
import laura.core.DiscordUser;
import laura.lib.jsoup.Connection;
import laura.network.ConnectionManager;
import laura.network.ConnectionState;
...
public class DiscordIPC implements Closeable {
    ...
    public JsonObject a(Activity activity) throws IOException {
        ...
        args.addProperty("pid", Long.valueOf(ProcessIdUtil.a()));
