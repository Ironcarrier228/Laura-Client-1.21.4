...
import laura.event.HotbarEvent;
...
public class Scaffold extends Module {
    ...
    public void a(InputEvent e) {
        ...
        if (s() != null) {
            ...
            if (this.b.c().booleanValue()) {
                Laura.getInstance().getModuleProcessor().t().ah().b(e);
            }
        }
        ...
        if (hotbarSlot != -1) {
            if (mc.player.getInventory().selectedSlot != hotbarSlot && this.e[2] < 7 && Laura.getInstance().getModuleProcessor().v().getInventoryHandler().a().isEmpty()) {
        ...
        int invSlot = d(false);
        if (this.e[2] < 5 && invSlot != -1 && Laura.getInstance().getModuleProcessor().v().getInventoryHandler().a().isEmpty()) {
            if (this.e[1] == -1) {
                this.e[1] = invSlot;
            }
            ...
            Laura.getInstance().getModuleProcessor().v().getInventoryHandler().moveItem(invSlot, 5, 1);
            this.e[2] = 9;
        }
    }
    ...
    public void a(GlobalEvent e) throws MatchException {
        ...
        Laura.getInstance().getModuleProcessor().k().startAiming(rotation, 100.0f, 7, 1);
        if (u() && !v() && !Laura.getInstance().getModuleProcessor().v().getStopHandler().a()) {
    ...
    public void c() {
        ...
        if (this.e[0] != -1 && mc.player != null) {
            ...
            if (this.e[1] != -1) {
                Laura.getInstance().getModuleProcessor().v().getInventoryHandler().moveItem(this.e[1], 5, 1);
            }
        }
        this.e[0] = -1;
        this.e[1] = -1;
