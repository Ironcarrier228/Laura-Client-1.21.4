...
public class AutoLeave extends Module {
    ...
    public void a(TickEvent event) {
        ...
        PlayerEntity near = mc.world.getPlayers().stream().filter(player -> {
            return player != mc.player && !(mc.player.squaredDistanceTo(player) > ((double) (this.d.c().floatValue() * this.d.c().floatValue()))) && !Laura.getInstance().getModuleProcessor().e().d(player.getName().getString());
