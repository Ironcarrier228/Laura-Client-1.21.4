...
import laura.config.PotionProcessor;
import laura.core.*;
...
public class Collector extends Module {
    private final List<b> d = Laura.getInstance().getModuleProcessor().p().e();
        ...
        if (this.h != null && event.isReceive()) {
            ...
            if (packet instanceof GameMessageS2CPacket) {
                ...
                if (message.toLowerCase().contains("[✘] Ошибка! Этот товар уже Купили!")) {
                    ...
                    Laura.getInstance().getModuleProcessor().v().getAFKHandler().a(10);
                }
            }
