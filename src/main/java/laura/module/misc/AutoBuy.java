            ...
            if (this.screenReady) {
                ...
                if (title.contains("аукцион")) {
                    ...
                    for (Slot slot : handler.slots.subList(0, Math.min(45, handler.slots.size()))) {
                        ...
                        AutoBuyEntry find = Laura.getInstance().getModuleProcessor().q().e().stream().filter(item -> {
                            if (item.l()) {
                                if (item.a(stack)) {
            ...
            if (title.contains("аукцион")) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (i < this.d.size()) {
                        ...
                        Laura.getInstance().getModuleProcessor().j().a(context, stack, x + 1, slotY + 1, 0, 1.0f, 1.0f, true);
