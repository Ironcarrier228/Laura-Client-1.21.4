...
import laura.handler.InteractHandler;
...
public class AncientFarmer extends Module {
    ...
    public void onTick(TickEvent event) {
        ...
        XRay xray = Laura.getInstance().getModuleProcessor().t().E();
        ...
        InteractHandler eat = Laura.getInstance().getModuleProcessor().v().getInteractHandler();
            ...
            case TNT:
                ...
                if (primed) {
                    ...
                    if (flint != -1) {
                        ...
                        if (aim != null) {
                            Laura.getInstance().getModuleProcessor().k().startAiming(Rotation.a(eye, aim), 180.0f, 0, 1);
                    ...
                    if (target != null) {
                        if (slot3 != -1) {
                            ...
                            Laura.getInstance().getModuleProcessor().k().startAiming(Rotation.a(eye2, new Vec3d(((double) support.getX()) + 0.5d, support.getY() + 1, ((double) support.getZ()) + 0.5d)), 180.0f, 0, 1);
                            if (new Rotation(mc.player).a(Rotation.b()) < 1.0d && mc.player.age % 5 == 0) {
                ...
                if (this.d.a(1000L)) {
                    if (!xray.getDebrisList().isEmpty()) {
                        if (!baritone.getMineProcess().isActive()) {
                            ...
                            Laura.getInstance().f().a(false, "telegram", "message", "⛏️ AncientFarmer — Найдены древние обломки!\n\n📍 Позиций для добычи: %s\n".formatted(Integer.valueOf(xray.getDebrisList().size())));
                        }
