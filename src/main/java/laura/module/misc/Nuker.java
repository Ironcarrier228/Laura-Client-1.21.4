...
public class Nuker extends Module {
    ...
    public void onTick(TickEvent event) {
        MineAssistant assistant = Laura.getInstance().getModuleProcessor().t().ak();
        this.targetPos = null;
        ...
        if (this.targetPos != null) {
            ...
            Laura.getInstance().getModuleProcessor().k().startAiming(new Rotation(MathHelper.wrapDegrees(base.c() + MathUtil.a(-3.0f, 3.0f)), MathHelper.clamp(base.d() + MathUtil.a(-3.0f, 3.0f), -90.0f, 90.0f)), 180.0f, 1, 1);
