        ...
        if (event.c() && this.b.a("Трассировка до игрока").c().booleanValue()) {
            ...
            for (Entity entity : mc.world.getEntities()) {
                ...
                if (target != mc.player && target.isAlive()) {
                    ...
                    boolean isFriend = Laura.getInstance().getModuleProcessor().e().d(target.getName().getString());
            ...
            for (Entity entity : mc.world.getEntities()) {
                ...
                if (target != mc.player && target.isAlive()) {
                    ...
                    if (!this.b.a("Фильтр по друзьям").c().booleanValue() || isFriend) {
                        ...
                        event.getDraw2DProcessor().a(stack, Identifier.of("laura", "pictures/pointer.png"), (-this.c.c().floatValue()) / 2.0f, (-this.c.c().floatValue()) / 2.0f, this.c.c().floatValue(), this.c.c().floatValue(), 0.0f, isFriend ? ColorUtil.convertToARGB(85, 255, 85, InterfaceC0020Opcode.aL) : ColorUtil.convertToARGB(255, 255, 255, InterfaceC0020Opcode.aL));
                        stack.pop();
                    }
                }
            }
