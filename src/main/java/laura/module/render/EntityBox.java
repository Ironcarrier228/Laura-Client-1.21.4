            ...
            if (event.c()) {
                for (Entity entity : mc.world.getEntities()) {
                    if (shouldRender(entity)) {
                        event.getDraw3DProcessor().a(event.h(), entity.getBoundingBox().offset(MathUtil.a(entity, event.g()).subtract(entity.getPos())), this.colorSource.l("Статичный") ? this.colorSetting.c().intValue() : Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.PRIMARY).toIntColor(), 0.75f);
                    }
                }
                return;
            }
            ...
            if (this.visualMode.l("Квадрат") || this.visualMode.l("Углы")) {
                ...
                for (Entity entity : mc.world.getEntities()) {
                    ...
                    if (bounds != null) {
                        ...
                        int color = this.colorSource.l("Статичный") ? this.colorSetting.c().intValue() : ColorUtil.combineColorWithAlpha(Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.PRIMARY).toIntColor(), 255);
