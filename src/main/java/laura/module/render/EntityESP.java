            ...
            for (Entity entity : mc.world.getEntities()) {
                if (entity != mc.player) {
                    ...
                    if (key != null && this.trackedEntities.a(key).c().booleanValue()) {
                        int color = ((entity instanceof PlayerEntity) && Laura.getInstance().getModuleProcessor().e().d(entity.getName().getString())) ? ColorUtil.convertToARGB(0, 100, 0, InterfaceC0020Opcode.bN) : ColorUtil.convertToARGB(0, 0, 0, 80);
