...
public class TriggerBot extends Module {
    ...
    private void u() {
        ...
        boolean skip = false;
        if ((Laura.getInstance().getModuleProcessor().t().H().e || (mc.player.fallDistance > 2.0f && Laura.getInstance().getModuleProcessor().t().H().c.c().booleanValue())) && InventoryUtil.b(Items.MACE) != -1) {
            ...
            if ((!this.c && !MaceUtil.b() && Laura.getInstance().getModuleProcessor().t().H().b.c().booleanValue() && !hitNow) || !MaceUtil.a() || mc.player.isGliding()) {
                return;
            } else {
                skip = true;
            }
    ...
    private boolean b(LivingEntity entity) {
        ...
        return AuraUtil.a((Entity) entity, 4.0d + (mc.player.getVelocity().length() * 3.0d) + ((double) ((InventoryUtil.b(Items.MACE) == -1 || ((double) mc.player.fallDistance) <= 1.5d) ? 0.0f : 1.5f)) + ((double) ((Laura.getInstance().getModuleProcessor().t().H().m() && InventoryUtil.b(Items.MACE) != -1 && MaceUtil.a(mc.player, mc.world).map(p -> {
    ...
    private boolean d(LivingEntity e) {
        if (e instanceof PlayerEntity p) {
            return this.f.a("Игроки").c().booleanValue() && (this.f.a("Друзья").c().booleanValue() || !Laura.getInstance().getModuleProcessor().e().d(p.getName().getString()));
        }
