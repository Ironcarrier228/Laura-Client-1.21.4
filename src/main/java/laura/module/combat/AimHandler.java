...
public class AimHandler extends BaseHandler implements Interface {
    ...
    public void onDraw(DrawEvent event) {
        ...
        if (event.b() && this.target != null && alpha > 0.0f) {
            ...
            event.getDraw2DProcessor().a(event.h(), Identifier.of("laura", "pictures/marker.png"), (-size) / 2.0f, (-size) / 2.0f, size,
    ...
    public void onTick(TickEvent event) {
        ProjectileHelper projectile = Laura.getInstance().getModuleProcessor().t().D();
