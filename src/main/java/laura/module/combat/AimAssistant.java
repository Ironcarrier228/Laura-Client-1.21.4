...
public class AimAssistant extends Module {
    ...
    public void onTick(TickEvent event) {
        TriggerBot trigger = Laura.getInstance().getModuleProcessor().t().X();
    ...
    private boolean isTargetAllowed(LivingEntity entity) {
        if (entity instanceof PlayerEntity player) {
            return this.b.a("Игроки").c().booleanValue() && (this.b.a("Друзья").c().booleanValue() || !Laura.getInstance().getModuleProcessor().e().d(player.getName().getString()));
        }
