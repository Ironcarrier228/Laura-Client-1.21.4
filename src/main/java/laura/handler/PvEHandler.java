...
public class PvEHandler extends BaseHandler implements Interface {
    ...
    public void onPacketEvent(PacketEvent event) {
        ...
        if (class_7439VarD instanceof GameMessageS2CPacket) {
            ...
            if (gameMsg.content().getString().equals("Данная команда недоступна в режиме AFK")) {
                Laura.getInstance().getModuleProcessor().v().getAFKHandler().a(7);
            }
        }
    }
    ...
    static final class c implements Interface, b {
        ...
        public boolean isComplete() {
            InventoryHandler handler = Laura.getInstance().getModuleProcessor().v().getInventoryHandler();
            ...
            switch (this.phase) {
                ...
                case 1:
                    ...
                    Laura.getInstance().getModuleProcessor().v().getPvEHandler().getTaskQueue().addFirst(new a(Items.EXPERIENCE_BOTTLE, 128, 2000));
                    return false;
                case 2:
                    if (!handler.a().isEmpty() || offHand.getItem() != this.tool) {
                        return false;
                    ...
                    Laura.getInstance().getModuleProcessor().k().startAiming(new Rotation(mc.player.getYaw(), 90.0f), 360.0f, 1, 1);
