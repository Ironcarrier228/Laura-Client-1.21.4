    ...
    public void a(DrawContext context, int mouseX, int mouseY, Vector2f center) {
        ...
        while (slot < count) {
            ...
            if (segment != null) {
                ...
                int primary = ColorUtil.combineColorWithAlpha(Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.PRIMARY).toIntColor(), 80);
                ...
                if (!segment.b.isEmpty()) {
                    Laura.getInstance().getModuleProcessor().j().a(context, segment.b, iconX - 8.0f, iconY - 8.0f, 0, 1.0f, 1.0f, false);
