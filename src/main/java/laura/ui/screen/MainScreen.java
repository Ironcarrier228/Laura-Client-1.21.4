...
public class MainScreen extends Screen {
    ...
    public static void a(DrawContext context, int width, int height, int mouseX, int mouseY, float scale) {
        ...
        matrices.translate((-width) / 2.0f, (-height) / 2.0f, 0.0f);
        Laura.getInstance().getModuleProcessor().i().a(matrices, Identifier.of("laura", "pictures/main.png"), (-marginX) + a[0], (-marginY) + a[1], width + (marginX * 2.0f), height + (marginY * 2.0f), 0.0f, -1);
        matrices.pop();
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        Laura.getInstance().getModuleProcessor().i().e().a(context.getMatrices());
    ...
    private void a(DrawContext context, float centerX, float titleY, float open) {
        float titleWidth = Fonts.e.a("Laura Client", 12.0f);
        MatrixStack matrices = context.getMatrices();
        float scale = 0.85f + (0.15f * EasingList.s.ease(open));
        matrices.push();
        ...
        Fonts.e.a(matrices, GradientUtil.a("Laura Client", primary, 5.0f, 0.5f), centerX - (titleWidth / 2.0f), titleY + 1.5f, 12.0f, 0.0f, open);
