...
public class StationScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        Draw2DProcessor draw2DProcessorI = Laura.getInstance().getModuleProcessor().i();
        ThemeProcessor themeProcessorO = Laura.getInstance().getModuleProcessor().o();
        ...
        Draw2DProcessor draw2DProcessorI2 = Laura.getInstance().getModuleProcessor().i();
        float f7 = this.h;
        draw2DProcessorI2.a(context, f7 - 3.0f, this.c.y + this.c.w, 6.0f, 0.5f, Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.PRIMARY).toIntColor());
    ...
    private void a(DrawContext context, float delta, int background) {
        ...
        draw.a(context.getMatrices(), Identifier.of("laura", "icon.png"), avatarX, this.c.y + ((this.c.w - 12.0f) / 2.0f), 12.0f, 12.0f, 5.0f, -1);
