...
import laura.core.Processor;
import laura.network.AccountConstructor;
import laura.render.*;
import laura.ui.element.TextField;
import laura.ui.shader.BlurShader;
...
public class AltScreen extends Screen {
                        ...
                        if (class_310Var2 != null && (class_1041VarMethod_22683 = class_310Var2.getWindow()) != null) {
                            ...
                            if (class_310Var3 != null && (class_1041VarMethod_22684 = class_310Var3.getWindow()) != null) {
                                ...
                                if (aVar != null) {
                                    ...
                                    Laura deltaH = Laura.getInstance();
                    ...
                    if (aVar2 != null) {
                        ...
                        if (aVar3 != null && (accountConstructor = aVar3.b) != null) {
                            ...
                            if (accountConstructor2 != null) {
                                ...
                                Laura.getInstance().getModuleProcessor().h().save();
                            }
                        }
                    }
                } else {
    ...
    private void a(MatrixStack matrices, int w, float px, float py, float open) {
        ...
        AccountConstructor selected = Laura.getInstance().getModuleProcessor().h().a();
    ...
    private int a(float open) {
        int rgba = Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.PRIMARY).toIntColor();
    ...
    private List<AccountConstructor> a() {
        return Laura.getInstance().getModuleProcessor().h().e();
    }
