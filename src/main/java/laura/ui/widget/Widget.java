...
public class Widget {
    ...
    public void a(GlobalEvent event) {
        e().a(this.i == Laura.getInstance().getModuleProcessor().s().getActiveDragInfo());
    }
    ...
    protected void a(DrawEvent event, String icon, Object title, float width, float animation) {
        a(event, icon, title, width, animation, Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.PRIMARY).toIntColor());
    }
    ...
    private void a(DrawEvent event, float x, float y, String icon, ItemStack stack, Object title, float width,
        ...
        if (animation > 0.0f) {
            ...
            if (stack != null) {
                Laura.getInstance().getModuleProcessor().j().a(event.i(), stack, x + 3.0f, (y + ((this.d - 8.0f) / 2.0f)) - 0.25f, 0,
            ...
            if (title instanceof Text text) {
                ...
                Fonts.e.a(event.h(), String.valueOf(title), x + 17.5f,
                        (y + ((this.d - Fonts.e.a(this.e)) / 2.0f)) - 0.5f, this.e, ColorUtil.applyAlphaToColor(Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.TEXT).toIntColor(), animation));
            }
        }
    }
    ...
    protected void a(DrawEvent event, float x, float y, float width, float height, boolean glow, float animation) {
        if (animation > 0.0f) {
            ThemeProcessor themeProcessor = Laura.getInstance().getModuleProcessor().o();
