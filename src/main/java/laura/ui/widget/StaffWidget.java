...
import laura.staff.StaffConstructor;
...
public class StaffWidget extends Widget implements Interface {
    ...
    public void a(DrawEvent event) {
        ...
        for (StaffConstructor staff : Laura.getInstance().getModuleProcessor().f().a()) {
            if (staff.b().c() > 0.0f) {
        ...
        for (StaffConstructor staff2 : Laura.getInstance().getModuleProcessor().f().a()) {
            ...
            if (animation > 0.0f) {
                ...
                if (entry != null) {
                    ...
                    Fonts.a.a(event.h(), "y", x + offsetX + 5.0f, drawY + ((11.5f - Fonts.a.a(8.0f)) / 2.0f), 8.0f, ColorUtil.applyAlphaToColor(Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.PRIMARY).toIntColor(), animation));
                }
                Fonts.e.a(event.h(), staff2.a(), x + offsetX + 19.0f, textY, 6.5f, ColorUtil.applyAlphaToColor(Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.TEXT).toIntColor(), animation));
