...
import laura.module.misc.StreamerMode;
import laura.render.*;
...
public class TargetWidget extends Widget {
    ...
    public void a(DrawEvent event) {
        ...
        if (a() > 0.0f && this.j != null) {
            ...
            if (this.j instanceof AbstractClientPlayerEntity player) {
                ...
                Fonts.a.a(event.h(), "B", x + 6.5f + ((headSize - 24.0f) / 2.0f), headY + ((headSize - 24.0f) / 2.0f), 24.0f, ColorUtil.applyAlphaToColor(Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.TEXT).toIntColor(), a()));
            }
            float textX = x + 5.0f + headSize + 5.0f;
            StreamerMode streamerMode = Laura.getInstance().getModuleProcessor().t().aE();
            ...
            String name = string;
            if (name.length() > 12) {
                Fonts.e.c(event.h(), name, textX, headY, 7.5f, ColorUtil.applyAlphaToColor(Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.TEXT).toIntColor(), a()), Fonts.e.a(name.substring(0, 12), 7.5f));
            } else {
                Fonts.e.a(event.h(), name, textX, headY, 7.5f, ColorUtil.applyAlphaToColor(Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.TEXT).toIntColor(), a()));
            }
            ...
            float alpha = Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.BACKGROUND_HUD).getAlphaFloat() * a();
    ...
    public void a(GlobalEvent event) {
        ...
        LivingEntity targets = Laura.getInstance().getModuleProcessor().t().B().getTarget() != null ? Laura.getInstance().getModuleProcessor().t().B().getTarget() : Laura.getInstance().getModuleProcessor().t().X().getTarget();
