...
import laura.mixin.IItemCooldownManager;
    ...
    public void a(DrawEvent event) {
        ...
        for (Map.Entry<Identifier, Object> entry2 : accessor.getEntries().entrySet()) {
            ...
            if (animation > 0.0f) {
                ...
                Fonts.e.a(event.h(), item2.getName().getString(), x + offsetX + 19.0f, textY, 6.5f, ColorUtil.applyAlphaToColor(Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.TEXT).toIntColor(), animation));
                Fonts.e.a(event.h(), time, ((((x + offsetX) + width) - 5.0f) - timeWidth) - 1.0f, textY, 6.5f, ColorUtil.applyAlphaToColor(Laura.getInstance().getModuleProcessor().o().a(ThemeInfo.TEXT).toIntColor(), 0.55f * animation));
