...
public class ColorElement extends Element<ColorSetting> {
    ...
    public void renderColorPicker(DrawContext context, double mouseX, double mouseY, float delta) {
        ...
        if (anim > 0.0f) {
            ...
            draw.a(matrices, Identifier.of("laura", "pictures/color.png"), this.hueBar.x, this.hueBar.y, this.hueBar.z, this.hueBar.w, this.hueBar.z / 4.0f, ColorUtil.applyAlphaToColor(16777215, anim));
            draw.a(context, this.hueBar.x - 1.0f, (this.hueBar.y + (this.h * this.hueBar.w)) - 0.5f, knob, 1.0f, handle);
            draw.a(matrices, Identifier.of("laura", "pictures/opacity.png"), this.g.x, this.g.y, this.g.z, this.g.w, this.g.z / 4.0f, ColorUtil.applyAlphaToColor(16777215, 0.019607844f * anim));
